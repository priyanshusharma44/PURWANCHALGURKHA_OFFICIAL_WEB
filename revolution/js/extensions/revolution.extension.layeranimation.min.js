    ...
    animateSingleCaption: function (a, r, s, f, b, x, T) {
      ...
      if (
        ...
        "fullscreen" == r.sliderLayout &&
          (f = S / 2 - (r.gridheight[r.curWinRange] * r.bh) / 2),
      ...
      if (
        ("off" == O ||
        (Q < r.hideCaptionAtLimit && "on" == a.data("captionhidden")) ||
        Q < r.hideAllCaptionAtLimit
        ...
        void 0 == B && (B = 0),
          void 0 == A && (A = 0),
          "off" !== k
            ? ("grid" != _ && P ? H.width(B) : H.width(B * r.bw),
              "grid" != _ && X ? H.height(A) : H.height(A * r.bh))
            : (H.width(B), H.height(A));
      }
      "slide" === _ && ((s = 0), (f = 0));
      ...
      if (
        ...
        ((0 == Z && !G) ||
          (1 != a.data("forcecover") &&
            ...
            !G)) &&
          (H.width(B * r.bw), H.height(A * r.bh));
      }
      ...
      if (
        ...
        if (!a.data("$anims") || T || Ra) {
          ...
          (Ia = p(Ia, a.data("transform_idle"))),
            ...
            (Ia.anim.ease = ka.anim.ease =
              ka.anim.ease || punchgs.Power1.easeInOut),
            Qa &&
                ...
                function (a) {
                  ...
                  i &&
                    ...
                    "none" === e.data("newhoveranim")
                      ...
                      : (e.data("newhoveranim").progress(0),
                        e.data("newhoveranim").play(),
                        La.svg &&
        ...
        if (
          ((Ca.f.anim.x =
            Ca.f.anim.x * r.bw ||
            l(Ca.f.anim.x, r, ra, da, wa, fa, "horizontal")),
          (Ca.f.anim.y =
            Ca.f.anim.y * r.bw ||
            l(Ca.f.anim.y, r, ra, da, wa, fa, "vertical")),
          2 != W || T)
        ) {
          if (Wa != a) {
            var Ma = Ca.r.anim.ease;
            Ta.add(punchgs.TweenLite.set(a, Ca.r.anim)),
              (Ca.r = i()),
              (Ca.r.anim.ease = Ma);
          }
          if (
            ...
            (Oa.ease = Ca.r.anim.ease),
              ...
              (Sa.anim.x =
                Sa.anim.x * r.bw ||
                l(Sa.anim.x, r, ra, da, wa, fa, "horizontal")),
              (Sa.anim.y =
                Sa.anim.y * r.bw ||
                l(Sa.anim.y, r, ra, da, wa, fa, "vertical")),
              Ta.add(
            ...
            Ta.add(
              punchgs.TweenLite.set(R, { overflow: "visible" }, ka.elemdelay),
              0
            );
        }
        if (
      ...
      "on" == a.data("loopanimation") &&
        punchgs.TweenLite.set(C, { minWidth: ra, minHeight: da }),
        0 == a.data("slidelink") ||
        (1 != a.data("slidelink") && !a.hasClass("slidelink"))
          ? (punchgs.TweenLite.set(R, { width: "auto", height: "auto" }),
            a.data("slidelink", 0))
          : (punchgs.TweenLite.set(R, { width: "100%", height: "100%" }),
            a.data("slidelink", 1));
    },
